---
name: xlfg:review
description: Run profile-aware multi-lens review as confirmation against why, proof, and the chosen root solution.
...
- keep one section for `Why / root-solution drift`
...
- no serious drift from `why.md` or `solution-decision.md` remains
