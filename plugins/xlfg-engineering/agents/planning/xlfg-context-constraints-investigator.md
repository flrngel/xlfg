...
Stay in the constraint lane: do not restate adjacent scope expansions or unknowns except when a hard constraint changes acceptance. Cite sibling artifacts under `Covered elsewhere` instead of repeating their findings.
