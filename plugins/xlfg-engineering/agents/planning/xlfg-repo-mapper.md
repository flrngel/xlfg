...
4. Determine the canonical commands to:
   ...
   - Build / package
5. Stop at command and structure inventory. Do not choose harness intensity, review lenses, scenario proof, or implementation task order; those are owned by later planning lanes.
