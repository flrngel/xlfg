...
Stay in the unknowns lane: do not repeat adjacent requirements or constraints already classified by sibling artifacts. Convert only the remaining uncertainty into safe assumptions, deferred decisions, or true blockers.
