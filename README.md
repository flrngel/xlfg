...
`/xlfg` is a **why-first, recall-first, proof-aware** software development harness for agents building production-grade services.
...
4. A research + comparison note for this patch: `docs/deer-flow-harness-review.md`.
...
### New discipline
- `/xlfg` itself now starts with recall and flows into a why-first planning step
- planning must write `why.md`, `memory-recall.md`, `harness-profile.md`, `workboard.md`, and `proof-map.md` before coding
